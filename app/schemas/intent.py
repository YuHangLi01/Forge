...
_MODIFICATION_TYPE_ALIASES: dict[str, str] = {
    ...
    "style": "reformat",
    "resize": "reformat",
    "resize_element": "reformat",
    "scale": "reformat",
    "scale_element": "reformat",
    "shrink": "reformat",
    "shrink_element": "reformat",
    "enlarge": "reformat",
    "enlarge_element": "reformat",
    "adjust": "reformat",
    "adjust_layout": "reformat",
    "adjust_size": "reformat",
    "adjust_position": "reformat",
    "move": "reformat",
    "move_element": "reformat",
    "layout": "reformat",
    "remove": "delete",
    "erase": "delete",
